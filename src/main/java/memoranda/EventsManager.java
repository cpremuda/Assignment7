...
/*			_root.addNamespaceDeclaration("jnevents", NS_JNEVENTS);
	...
	// TASK 1 - Complexity
	private static Year doYear(CalendarDate date) {
	...
	private static Month doMonth(CalendarDate date, Year y) {
	...
	private static Day doDay(CalendarDate date, Month m) {
